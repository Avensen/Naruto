       ...
       <div class="flex-grow mx-auto max-w-7xl w-full flex flex-col px-4 sm:px-6 lg:px-8">
         <div class="flex-shrink-0 pt-10 sm:pt-16">
           <a href="/" class="inline-flex">
             ...
             <img class="h-12 w-auto" src="logo.svg" alt="Konoha Logo">
           </a>
         </div>
         <div class="flex-shrink-0 my-auto py-16 sm:py-32">
           <p class="text-sm font-semibold text-primary uppercase tracking-wide">Error 404</p>
           <h1 class="mt-2 text-4xl font-extrabold text-gray-900 tracking-tight sm:text-5xl">Ups, por aquí no es</h1>
           <p class="mt-2 text-base text-gray-500">Creo que nos hemos perdido :(</p>
           <div class="mt-6">
             <a href="#" class="text-base font-medium hover:text-primary text-orange-500">Volver a la aldea<span aria-hidden="true"> &rarr;</span></a>
           </div>
         </div>
       </div>
     </main>
